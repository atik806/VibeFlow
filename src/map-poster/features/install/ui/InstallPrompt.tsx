...
import { INSTALL_DIAGNOSTICS_ENABLED } from "@/map-poster/core/config";
        ...
        <div className="install-prompt" role="complementary">
          <span className="install-prompt-text">
            <MobileIcon
              ...
              aria-hidden="true"
            />
            Install VibeFlow Map Poster for faster access and a better experience.
          </span>
        ...
        <div className="install-prompt" role="complementary">
          <span className="install-prompt-text">
            <MobileIcon
              ...
              aria-hidden="true"
            />
            For faster access and a better experience, install VibeFlow Map Poster from
            your browser menu:
