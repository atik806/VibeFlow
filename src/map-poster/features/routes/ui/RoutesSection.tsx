...
import { useGpxUpload } from "@/map-poster/features/routes/application/useGpxUpload";
import type {
  Route,
  RouteBounds,
  RouteEndpointMarker,
} from "@/map-poster/features/routes/domain/types";
import {
  MAX_MARKER_SIZE,
  MIN_MARKER_SIZE,
} from "@/map-poster/features/markers/domain/constants";
import { routeLengthMeters } from "@/map-poster/features/routes/infrastructure/helpers";
import {
  ROUTE_LINE_STYLES,
  MAX_ROUTE_OPACITY,
...
} from "@/map-poster/features/routes/domain/constants";
import ColorPicker from "@/map-poster/features/theme/ui/ColorPicker";
import { buildDynamicColorChoices } from "@/map-poster/features/theme/domain/colorSuggestions";
import {
  DISPLAY_PALETTE_KEYS,
  type ThemeColorKey,
} from "@/map-poster/features/theme/domain/types";
import { getThemeColorByPath } from "@/map-poster/features/theme/domain/colorPaths";
import { CheckIcon, CloseIcon, TrashIcon } from "@/map-poster/shared/ui/Icons";
import MarkerVisual from "@/map-poster/features/markers/ui/MarkerVisual";
import {
  findMarkerIcon,
  predefinedMarkerIcons,
} from "@/map-poster/features/markers/infrastructure/iconRegistry";
