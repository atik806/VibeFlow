...
import { featuredMarkerIcons } from "@/map-poster/features/markers/infrastructure/iconRegistry";
import { clamp } from "@/map-poster/shared/geo/math";
import type { Route, RouteDefaults } from "@/map-poster/features/routes/domain/types";
import {
  MAX_ROUTE_OPACITY,
