...
import { geocodeLocation, reverseGeocodeCoordinates } from "@/map-poster/core/services";
import { GEOLOCATION_TIMEOUT_MS } from "@/map-poster/features/map/infrastructure";
import {
  getGeolocationFailureMessage,
  requestCurrentPositionWithRetry,
} from "@/map-poster/features/location/infrastructure";
import { MyLocationIcon } from "@/map-poster/shared/ui/Icons";
import { usePosterDispatch } from "@/map-poster/features/poster/ui/PosterContext";
  ...
  return (
    ...
    >
      <div className="startup-location-logo-wrap" aria-hidden="true">
        ...
        <p className="startup-location-app-name">VibeFlow Map Poster</p>
      </div>
