...
import { KOFI_URL, SOCIAL_INSTAGRAM, AD_SLOT_MODAL } from "@/map-poster/core/config";
import { CloseIcon, InstagramIcon } from "@/map-poster/shared/ui/Icons";
import AdUnit from "@/map-poster/shared/ui/AdUnit";
import type { SupportPromptVariant } from "@/map-poster/features/export/application/useExport";
        ...
        <div className="support-modal__body">
          {variant === "first" ? (
            ...
            <>
              ...
              <p className="support-modal__text">
                If VibeFlow helped you create this poster, consider supporting the project.
              </p>
              <p className="support-modal__text">
