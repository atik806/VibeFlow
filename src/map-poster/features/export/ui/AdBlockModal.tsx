...
import { CloseIcon } from "@/map-poster/shared/ui/Icons";
          ...
          {variant === "warning" ? (
            <>
              <p className="support-modal__headline" id="adblock-modal-title">
                Ads keep VibeFlow free
              </p>
              <p className="support-modal__text">
                VibeFlow Map Poster is 100% free. Ads help cover server and
                development costs — please consider disabling your ad blocker
