...
import type { ExportFormat } from "@/map-poster/features/export/domain/types";
import { captureMapAsCanvas } from "@/map-poster/features/export/infrastructure/mapExporter";
import { compositeExport } from "@/map-poster/features/poster/infrastructure/renderer";
import { resolveCanvasSize } from "@/map-poster/features/poster/infrastructure/renderer/canvas";
import { getAllMarkerIcons } from "@/map-poster/features/markers/infrastructure/iconRegistry";
import { ensureGoogleFont } from "@/map-poster/core/services";
import {
  createPngBlob,
  ...
  triggerDownloadBlob,
} from "@/map-poster/core/services";
import {
  CM_PER_INCH,
  DEFAULT_POSTER_WIDTH_CM,
  DEFAULT_POSTER_HEIGHT_CM,
} from "@/map-poster/core/config";
import { checkAdBlockerNow } from "@/map-poster/features/export/application/adBlockDetection";
import {
  canDownloadWithAdBlock,
  hoursUntilAdBlockReset,
  recordAdBlockDownload,
} from "@/map-poster/features/export/application/adBlockLimit";

export const ADBLOCK_LIMIT_EVENT = "vf:map-poster:adblock-limit";
export const ADBLOCK_WARN_EVENT = "vf:map-poster:adblock-warn";

const EXPORT_COUNT_STORAGE_KEY = "vf.map-poster.count";
...
export const SUPPORT_PROMPT_EVENT = "vf:map-poster:support-prompt";
