...
import { usePosterContext } from "@/map-poster/features/poster/ui/PosterContext";
import {
  MAX_MARKER_SIZE,
  MIN_MARKER_SIZE,
} from "@/map-poster/features/markers/domain/constants";
import GeneralHeader from "@/map-poster/shared/ui/GeneralHeader";
import DesktopNavBar from "@/map-poster/shared/ui/DesktopNavBar";
import FooterNote from "@/map-poster/shared/ui/FooterNote";
import PreviewPanel from "@/map-poster/features/poster/ui/PreviewPanel";
import MobileNavBar, { type MobileTab } from "@/map-poster/shared/ui/MobileNavBar";
import InstallPrompt from "@/map-poster/features/install/ui/InstallPrompt";
import { useSwipeDown } from "@/map-poster/shared/hooks/useSwipeDown";
import StartupLocationModal from "@/map-poster/features/location/ui/StartupLocationModal";
import { CheckIcon } from "@/map-poster/shared/ui/Icons";
import SupportModal from "@/map-poster/features/export/ui/SupportModal";
import AdBlockModal from "@/map-poster/features/export/ui/AdBlockModal";
import {
  SUPPORT_PROMPT_EVENT,
  ADBLOCK_LIMIT_EVENT,
  ADBLOCK_WARN_EVENT,
  type SupportPromptState,
} from "@/map-poster/features/export/application/useExport";

const AboutModal = lazy(() => import("@/map-poster/shared/ui/AboutModal"));
const SettingsPanel = lazy(() => import("@/map-poster/features/poster/ui/SettingsPanel"));
const AnnouncementModal = lazy(
  () => import("@/map-poster/features/updates/ui/AnnouncementModal"),
);
const ExportFab = lazy(() => import("@/map-poster/features/export/ui/ExportFab"));
const DesktopLocationBar = lazy(() => import("@/map-poster/shared/ui/DesktopLocationBar"));
...
export default function AppShell() {
  ...
  useEffect(() => {
    const preload = () => {
      void import("@/map-poster/features/poster/ui/SettingsPanel");
      void import("@/map-poster/shared/ui/DesktopLocationBar");
      void import("@/map-poster/features/export/ui/ExportFab");
      void import("@/map-poster/features/updates/ui/AnnouncementModal");
    };
