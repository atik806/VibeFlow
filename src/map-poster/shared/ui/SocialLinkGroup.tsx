import { KOFI_URL, REPO_API_URL, REPO_URL, SOCIAL_INSTAGRAM } from "@/map-poster/core/config";
import { useRepoStars } from "@/map-poster/shared/hooks/useRepoStars";
import { GitHubIcon, InstagramIcon, KofiIcon, StarIcon } from "@/map-poster/shared/ui/Icons";
    ...
    <div className={rootClassName} aria-label="Project links">
      {repoUrl ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Open VibeFlow repository on GitHub"
      ...
      {instagramUrl ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Follow VibeFlow on Instagram"
          title="Instagram"
        >
          <InstagramIcon />
        </a>
      ...
      {kofiUrl ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Support VibeFlow on Ko-fi"
          title="Ko-fi"
        >
          <KofiIcon />
        </a>
